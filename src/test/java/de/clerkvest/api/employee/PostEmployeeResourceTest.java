...
public class PostEmployeeResourceTest {
    ...
    public void addEmployee_ToOwnCompany_Admin() {
        EmployeeDTO employee0 = EmployeeDTO.builder().employeeId(0L).companyId(0L).email("user3@clerkvest.de").balance(BigDecimal.valueOf(10)).token(null).firstname("Mike").lastname("User").nickname("User1ClerkNonAdmin").admin(false).build();
    ...
    public void addEmployee_ToOwnCompany_DuplicateMail() {
        ...
        EmployeeDTO employee0 = EmployeeDTO.builder().employeeId(0L).companyId(0L).email("user1@clerkvest.de").balance(BigDecimal.valueOf(10)).token(null).firstname("Mike").lastname("User").nickname("User1ClerkNonAdmin").admin(false).build();
