...
public class GetEmployeeResourceTest {
    ...
    public void getEmployee_0() {
        EmployeeDTO rest = given().header("X-API-Key", "exampleToken1").get(REST_ENDPOINT_URL + 0).then().statusCode(OK.value()).extract().as(EmployeeDTO.class);
    ...
    public void getEmployee_1() {
        EmployeeDTO rest = given().header("X-API-Key", "exampleToken1").get(REST_ENDPOINT_URL + 1).then().statusCode(OK.value()).extract().as(EmployeeDTO.class);
    ...
    public void getEmployee_2() {
        EmployeeDTO rest = given().header("X-API-Key", "exampleToken2").get(REST_ENDPOINT_URL + 2).then().statusCode(OK.value()).extract().as(EmployeeDTO.class);
    ...
    public void getEmployee_3() {
        EmployeeDTO rest = given().header("X-API-Key", "exampleToken3").get(REST_ENDPOINT_URL + 3).then().statusCode(OK.value()).extract().as(EmployeeDTO.class);
