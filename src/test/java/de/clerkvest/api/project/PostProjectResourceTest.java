...
public class PostProjectResourceTest {
    ...
    public void addProject_ToOwnCompany_Admin() {
        EmployeeDTO employee1 = given().header("X-API-Key", "exampleToken1").get(HateoasLink.EMPLOYEE_SINGLE + 1).as(EmployeeDTO.class);
    ...
    public void addProject_ToOwnCompany_NonAdmin() {
        EmployeeDTO employee0 = given().header("X-API-Key", "exampleToken0").get(HateoasLink.EMPLOYEE_SINGLE + 0).as(EmployeeDTO.class);
    ...
    public void addProject_ToCompany_ForeignAdmin() {
        EmployeeDTO employee3 = given().header("X-API-Key", "exampleToken3").get(HateoasLink.EMPLOYEE_SINGLE + 3).as(EmployeeDTO.class);
        CompanyDTO company = given().header("X-API-Key", "exampleToken0").get(HateoasLink.COMPANY_SINGLE + 0).as(CompanyDTO.class);
    ...
    public void addProject_ToCompany_FakeCompany() {
        CompanyDTO company = given().header("X-API-Key", "exampleToken3").get(HateoasLink.COMPANY_SINGLE + 1).as(CompanyDTO.class);
        EmployeeDTO employee0 = given().header("X-API-Key", "exampleToken0").get(HateoasLink.EMPLOYEE_SINGLE + 0).as(EmployeeDTO.class);
