...
public class SpringConfig {
    ...
    public ModelMapper modelMapper() {
        ...
        investMap.addMapping(src -> src.getEmployeeId().getId(),InvestDTO::setEmployeeId);
        ...
        investMap.addMapping(src -> src.getProjectId().getId(),InvestDTO::setProjectId);
        ...
        projectMap.addMapping(src -> src.getEmployeeId().getId(),ProjectDTO::setEmployeeId);
        ...
        projectCommentMap.addMapping(ProjectComment::getEmployeeId,ProjectCommentDTO::setEmployeeId);
        projectCommentMap.addMapping(ProjectComment::getProjectCommentId,ProjectCommentDTO::setProjectCommentId);
        projectCommentMap.addMapping(ProjectComment::getProjectId,ProjectCommentDTO::setProjectId);
